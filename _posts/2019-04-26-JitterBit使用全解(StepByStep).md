...
![jitter01](/assets/BlogJitterbit/jitterbit01.jpg "pic01")
...
![jitter02](/assets/BlogJitterbit/jitterbit02.jpg "pic02")

+ ###### e. 点击Next，选择数据源，支持csv文件的导入以及各种数据库的连接。 
    输入数据库的地址，表名称以及账户
    点击Test Connection可以测试数据库连接成功与否

![jitter03](/assets/BlogJitterbit/jitterbit03.jpg "pic03")

+ ###### f. 点击Next，选择匹配关系。
可以进行拖拽匹配，或者点击左侧的数据库的字段名，然后双击右侧的API名称即可完成单个字段的匹配

![jitter04](/assets/BlogJitterbit/jitterbit04.jpg "pic04")
...
![jitter05](/assets/BlogJitterbit/jitterbit05.jpg "pic05")

### 如何管理JitterBit下的Operations
+ ###### 部署云端
点击右上角的上传按钮，可以部署你配置的操作到JitterBit 的云端，这样即便自己的电脑关机状态，也能保证实时的数据同步

![jitter06](/assets/BlogJitterbit/jitterbit06.jpg "pic06")
                                      
+ ###### 云端下载配置         
点击左上角的Actions→Restore Project from Cloud 
可以获取你已经部署到云端的所有配置（注意：此时会覆盖你本地的配置）

![jitter07](/assets/BlogJitterbit/jitterbit07.jpg "pic07")

### 关于JitterBit的云端管理平台
双击下图中标红的 Cloud Console 可以进入JitterBit 的云端管理平台

![jitter08](/assets/BlogJitterbit/jitterbit08.jpg "pic08")

下图便是JitterBit 的云端平台，Doshboard 页面可以看到连接的数量以及正在工作的配置信息

![jitter09](/assets/BlogJitterbit/jitterbit09.jpg "pic09")
